...
class ServiceController extends AbstractController
{
     ...
     */
    public function index(Employer $employe=null, Request $request, ObjectManager $manager)
    {
        if(!$employe){
        ...
        $form = $this->createFormBuilder($employe)
          ...
          if ($form->isSubmitted() && $form->isValid()) {
            ...
            $manager->flush();
            return $this->redirectToRoute('index', ['id'=> $employe->getId()
        ]);
    ...
    /** 
    * @Route("/service/{id}/sup", name="supp")
    */
    public function suppression(Employer $employe, ObjectManager $manager){
